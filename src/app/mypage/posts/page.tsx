...
const PostsPage = () => {
  ...
  const { data: reviews, isLoading: reviewsLoading, refetch: reviewsRefetch } = usePostReviewQuery();
  const { data: comments, isLoading: commentsLoading, refetch: commentsRefetch } = usePostCommentQuery();
